    ...
    <div className="bg-background min-h-screen flex flex-col pb-16 md:pb-0" dir={dir}>
      ...
      <Sheet open={sidebarOpen} onOpenChange={setSidebarOpen}>
        ...
        <SheetContent side="right" className="w-[320px] p-0 flex flex-col border-none shadow-2xl bg-gradient-to-b from-slate-50 to-white">
          ...
          <div className="relative bg-gradient-to-br from-[#FF4500] via-[#E83800] to-[#CC3300] px-5 pt-7 pb-14 overflow-hidden">
            {/* Decorative blobs */}
            ...
            <div className="relative flex items-center justify-center gap-3 mb-5">
              <div className="relative">
                ...
                {sidebarLogoUrl ? (
                  <img src={sidebarLogoUrl} alt={appName} className="relative h-16 w-16 object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]" />
                ) : (
              ...
              <div className="flex flex-col leading-none">
                ...
                <span className="text-[10px] font-bold text-white/70 tracking-[0.35em] mt-1">SAREE ONE</span>
              </div>
            </div>
          ...
          <div className="relative -mt-9 px-5 z-10">
            <button
              ...
              className="w-full flex items-center gap-3 p-3 rounded-2xl bg-white border border-slate-100 shadow-[0_10px_30px_-12px_rgba(14,23,41,0.25)] hover:shadow-[0_15px_35px_-10px_rgba(255,69,0,0.35)] transition-all"
              data-testid="button-profile-card"
            >
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#FF4500] to-[#FF6535] flex items-center justify-center text-white font-black text-lg shadow-md flex-shrink-0">
                ...
                return (
                  ...
                  >
                    <div className={`w-9 h-9 flex items-center justify-center rounded-xl flex-shrink-0 transition-colors ${
                      isActive
                        ? 'bg-gradient-to-br from-[#FF4500] to-[#FF6535] text-white shadow-md'
            ...
            <div className="flex items-center justify-center gap-3 mb-3">
              ...
              {showContactButton && (
                <button
                  ...
                  className="flex-1 max-w-[180px] h-11 flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-[#FF4500] to-[#FF6535] text-white font-black text-sm shadow-md hover:shadow-lg transition-all"
